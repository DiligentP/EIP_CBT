...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">문제 리스트</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
                문제 리스트
                <button id='writeBtn' type="button" class="btn btn-xs pull-right">문제 작성</button>
            </div>
            <!-- /.panel-heading -->
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${list}" var="question">
                        <tr>
                            ...
                            <td>
                                <a class='move' href='<c:out value="${question.qno}"/>'>
                                    <c:out value="${question.title}"/>
                                </a>
                            </td>
                            <td><c:out value="${question.total}"/></td>
                            <td><c:out value="${question.successer}"/></td>
                            <td><c:out value="${question.questionTag}"/></td>
