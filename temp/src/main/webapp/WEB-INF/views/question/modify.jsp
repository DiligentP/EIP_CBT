...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-heading">문제 Modify</div>
      <!-- /.panel-heading -->
...
<div class="form-group">
  ...
  <input class="form-control" name='correct'
    value='<c:out value="${question.correct}"/>'>            
</div>

<div class="form-group">
  <label>해설</label>
  <textarea class="form-control" rows="3" name='commentary' ><c:out value="${question.commentary}"/></textarea>
</div>

<div class="form-group">
  <label>태그</label> 
  <input class="form-control" name='questionTag'
    value='<c:out value="${question.questionTag}"/>'>            
</div>
...
<div class="form-group">
  ...
  <input class="form-control" name='regDate'
    value='<fmt:formatDate pattern = "yyyy/MM/dd" value = "${question.regDate}" />'  readonly="readonly">            
</div>

<div class="form-group">
  <label>Update Date</label> 
  <input class="form-control" name='updateDate'
    value='<fmt:formatDate pattern = "yyyy/MM/dd" value = "${question.updateDate}" />'  readonly="readonly">            
</div>
